...
DEFINE_BINARY_FUNCTION_INTEGER_FLONUM_FLONUMC_POINTER([[[add]]])
DEFINE_BINARY_FUNCTION_INTEGER_FLONUM_FLONUMC_POINTER([[[sub]]])
DEFINE_BINARY_FUNCTION_INTEGER_FLONUM_FLONUMC([[[mul]]])
DEFINE_BINARY_FUNCTION_INTEGER_FLONUM_FLONUMC([[[div]]])
DEFINE_BINARY_FUNCTION_INTEGER_FLONUM([[[modulo]]])
DEFINE_BINARY_FUNCTION_INTEGER_FLONUM([[[remainder]]])
DEFINE_UNARY_FUNCTION_INTEGER_FLONUM_FLONUMC([[[neg]]])
DEFINE_UNARY_FUNCTION_INTEGER_FLONUM_FLONUMC([[[inverse]]])
DEFINE_UNARY_FUNCTION_INTEGER_FLONUM_FLONUMC([[[absolute]]])
DEFINE_UNARY_FUNCTION_INTEGER_FLONUM([[[incr]]])
DEFINE_UNARY_FUNCTION_INTEGER_FLONUM([[[decr]]])
