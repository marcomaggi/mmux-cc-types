...
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_SLLONG]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[sllong]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_ULLONG]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[ullong]]]);]]])

    MMUX_DEFINE_SIZEOF_VARIABLE([[[float]]]);
    MMUX_DEFINE_SIZEOF_VARIABLE([[[double]]]);
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_LDOUBLE]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[ldouble]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT32]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[float32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT64]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[float64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT128]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[float128]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT32X]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[float32x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT64X]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[float64x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT128X]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[float128x]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL32]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[decimal32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL64]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[decimal64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL128]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[decimal128]]]);]]])

    MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf]]]);
    MMUX_DEFINE_SIZEOF_VARIABLE([[[complexd]]]);
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXLD]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexld]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXF32]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXF64]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXF128]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf128]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXF32X]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf32x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXF64X]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf64x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXF128X]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf128x]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXD32]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexd32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXD64]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexd64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_COMPLEXD128]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexd128]]]);]]])
...
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_SLLONG]]],[[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[sllong]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_ULLONG]]],[[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[ullong]]]);]]])

    MMUX_DEFINE_MAXIMUM_VARIABLE([[[float]]]);
    MMUX_DEFINE_MAXIMUM_VARIABLE([[[double]]]);
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_LDOUBLE]]],[[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[ldouble]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT32]]], [[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[float32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT64]]], [[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[float64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT128]]],[[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[float128]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT32X]]], [[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[float32x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT64X]]], [[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[float64x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT128X]]],[[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[float128x]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL32]]], [[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[decimal32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL64]]], [[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[decimal64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL128]]],[[[MMUX_DEFINE_MAXIMUM_VARIABLE([[[decimal128]]]);]]])
...
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_SLLONG]]],[[[MMUX_DEFINE_MINIMUM_VARIABLE([[[sllong]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_ULLONG]]],[[[MMUX_DEFINE_MINIMUM_VARIABLE([[[ullong]]]);]]])
    MMUX_DEFINE_MINIMUM_VARIABLE([[[float]]]);
    MMUX_DEFINE_MINIMUM_VARIABLE([[[double]]]);
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_LDOUBLE]]],[[[MMUX_DEFINE_MINIMUM_VARIABLE([[[ldouble]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT32]]], [[[MMUX_DEFINE_MINIMUM_VARIABLE([[[float32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT64]]], [[[MMUX_DEFINE_MINIMUM_VARIABLE([[[float64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT128]]],[[[MMUX_DEFINE_MINIMUM_VARIABLE([[[float128]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT32X]]], [[[MMUX_DEFINE_MINIMUM_VARIABLE([[[float32x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT64X]]], [[[MMUX_DEFINE_MINIMUM_VARIABLE([[[float64x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_FLOAT128X]]],[[[MMUX_DEFINE_MINIMUM_VARIABLE([[[float128x]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL32]]], [[[MMUX_DEFINE_MINIMUM_VARIABLE([[[decimal32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL64]]], [[[MMUX_DEFINE_MINIMUM_VARIABLE([[[decimal64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_CC_TYPE_DECIMAL128]]],[[[MMUX_DEFINE_MINIMUM_VARIABLE([[[decimal128]]]);]]])
