...
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_TYPE_FLOAT32]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf32]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_TYPE_FLOAT64]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf64]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_TYPE_FLOAT128]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf128]]]);]]])

MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_TYPE_FLOAT32X]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf32x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_TYPE_FLOAT64X]]], [[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf64x]]]);]]])
MMUX_BASH_CONDITIONAL_CODE([[[MMUX_HAVE_TYPE_FLOAT128X]]],[[[MMUX_DEFINE_SIZEOF_VARIABLE([[[complexf128x]]]);]]])
