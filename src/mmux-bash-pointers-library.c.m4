...
MMUX_BASH_BUILTIN_MAIN([[[mmux_bash_pointers_library_init]]])
{
...

  {
    ...
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[F_OFD_SETLK]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[F_OFD_SETLKW]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[F_OFD_GETLK]]])
    ...
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_AS]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_CORE]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_CPU]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_DATA]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_FSIZE]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_LOCKS]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_MEMLOCK]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_MSGQUEUE]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_NICE]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_NOFILE]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_NPROC]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_RSS]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_RTPRIO]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_RTTIME]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_SIGPENDING]]]);
    MMUX_DEFINE_INT_CONSTANT_VARIABLE([[[RLIMIT_STACK]]]);
    MMUX_DEFINE_ULONG_CONSTANT_VARIABLE([[[RLIM_INFINITY]]]);
