...
m4_divert(-1)
m4_define([[[DEFINE_STANDARD_FLONUMCD_REAL_NUMBER_FUNCTIONS_AND_PROTOS]]],[[[m4_dnl
mmux_cc_types_decl mmux_standard_flonumcd$1_t mmux_standard_flonumcd$1_sign (mmux_standard_flonumcd$1_t op)
  __attribute__((__const__));
]]])
m4_divert(0)m4_dnl
DEFINE_STANDARD_FLONUMCD_REAL_NUMBER_FUNCTIONS_AND_PROTOS(32)
DEFINE_STANDARD_FLONUMCD_REAL_NUMBER_FUNCTIONS_AND_PROTOS(64)
DEFINE_STANDARD_FLONUMCD_REAL_NUMBER_FUNCTIONS_AND_PROTOS(128)
