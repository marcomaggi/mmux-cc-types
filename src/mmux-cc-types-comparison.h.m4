...
DEFINE_STANDARD_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[ino]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[dev]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[nlink]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[blkcnt]]])
...
DEFINE_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[ino]]])
DEFINE_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[dev]]])
DEFINE_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[nlink]]])
DEFINE_EXACT_INTEGER_COMPARISON_INLINE_FUNCTIONS([[[blkcnt]]])
