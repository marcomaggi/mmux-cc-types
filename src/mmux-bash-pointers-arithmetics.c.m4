...
static int
mmux_bash_pointers_[[[]]]$1[[[]]]_add_main (int argc,  char * argv[])
#undef  MMUX_BUILTIN_NAME
#define MMUX_BUILTIN_NAME	"$1-add"
{
#if ($2)
...
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[mmux_bash_pointers_$1_add]]],
    [[[(3 <= argc)]]],
    [[["$1-add ROPVAR OP0 OP ..."]]],
...
static int
mmux_bash_pointers_pointer_add_main (int argc MMUX_BASH_POINTERS_UNUSED,  char * argv[])
#undef  MMUX_BUILTIN_NAME
#define MMUX_BUILTIN_NAME	"pointer-add"
{
...
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[mmux_bash_pointers_pointer_add]]],
    [[[(4 == argc)]]],
...
static int
mmux_bash_pointers_[[[]]]$1[[[]]]_sub_main (int argc,  char * argv[])
#undef  MMUX_BUILTIN_NAME
#define MMUX_BUILTIN_NAME	"$1-sub"
{
#if ($2)
  mmux_libc_$1_t	ops[argc]; /* we allocate two more of these, not a problem */
  int			rv;
...
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[mmux_bash_pointers_$1_sub]]],
    [[[(3 <= argc)]]],
    [[["$1-sub ROPVAR OP0 OP ..."]]],
...
static int
mmux_bash_pointers_[[[]]]$1[[[]]]_mul_main (int argc,  char * argv[])
#undef  MMUX_BUILTIN_NAME
#define MMUX_BUILTIN_NAME	"$1-mul"
{
#if ($2)
  mmux_libc_$1_t	ops[argc]; /* we allocate two more of these, not a problem */
  int			rv;
...
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[mmux_bash_pointers_$1_mul]]],
    [[[(3 <= argc)]]],
    [[["$1-mul ROPVAR OP0 OP ..."]]],
...
static int
mmux_bash_pointers_[[[]]]$1[[[]]]_div_main (int argc,  char * argv[])
#undef  MMUX_BUILTIN_NAME
#define MMUX_BUILTIN_NAME	"$1-div"
{
#if ($2)
  mmux_libc_$1_t	ops[argc]; /* we allocate two more of these, not a problem */
  int			rv;
...
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[mmux_bash_pointers_$1_div]]],
    [[[(3 <= argc)]]],
    [[["$1-div ROPVAR OP0 OP ..."]]],
...
static int
mmux_bash_pointers_[[[]]]$1[[[]]]_neg_main (int argc MMUX_BASH_POINTERS_UNUSED,  char * argv[])
#undef  MMUX_BUILTIN_NAME
#define MMUX_BUILTIN_NAME	"$1-neg"
{
#if ($2)
  mmux_libc_$1_t	op;
  int			rv;
...
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[mmux_bash_pointers_$1_neg]]],
    [[[(3 == argc)]]],
    [[["$1-neg ROPVAR OP"]]],
