...
DEFINE_EXACT_INTEGER_ALIASED_TYPE_FUNCTIONS(ino,	MMUX_CC_TYPES_STEM_ALIAS_INO)
DEFINE_EXACT_INTEGER_ALIASED_TYPE_FUNCTIONS(dev,	MMUX_CC_TYPES_STEM_ALIAS_DEV)
DEFINE_EXACT_INTEGER_ALIASED_TYPE_FUNCTIONS(nlink,	MMUX_CC_TYPES_STEM_ALIAS_NLINK)
DEFINE_EXACT_INTEGER_ALIASED_TYPE_FUNCTIONS(blkcnt,	MMUX_CC_TYPES_STEM_ALIAS_BLKCNT)
