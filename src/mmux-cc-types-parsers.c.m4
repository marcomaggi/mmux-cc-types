...
DEFINE_TYPEDEF_PARSER([[[ino]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_INO]]])
DEFINE_TYPEDEF_PARSER([[[dev]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_DEV]]])
DEFINE_TYPEDEF_PARSER([[[nlink]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_NLINK]]])
DEFINE_TYPEDEF_PARSER([[[blkcnt]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_BLKCNT]]])
...
DEFINE_STRING_IS_FUNCTION([[[ino]]])
DEFINE_STRING_IS_FUNCTION([[[dev]]])
DEFINE_STRING_IS_FUNCTION([[[nlink]]])
DEFINE_STRING_IS_FUNCTION([[[blkcnt]]])
