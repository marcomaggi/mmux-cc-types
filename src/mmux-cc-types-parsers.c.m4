...
DEFINE_TYPEDEF_PARSER([[[libc_mode]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_MODE]]])
DEFINE_TYPEDEF_PARSER([[[off]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_OFF]]])
DEFINE_TYPEDEF_PARSER([[[libc_pid]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_PID]]])
DEFINE_TYPEDEF_PARSER([[[libc_uid]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_UID]]])
DEFINE_TYPEDEF_PARSER([[[libc_gid]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_GID]]])
DEFINE_TYPEDEF_PARSER([[[wchar]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_WCHAR]]])
DEFINE_TYPEDEF_PARSER([[[wint]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_WINT]]])
DEFINE_TYPEDEF_PARSER([[[libc_time]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_TIME]]])
DEFINE_TYPEDEF_PARSER([[[libc_socklen]]],	[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_SOCKLEN]]])
DEFINE_TYPEDEF_PARSER([[[libc_rlim]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_RLIM]]])

DEFINE_TYPEDEF_PARSER([[[libc_ino]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_INO]]])
DEFINE_TYPEDEF_PARSER([[[libc_dev]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_DEV]]])
DEFINE_TYPEDEF_PARSER([[[libc_nlink]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_NLINK]]])
DEFINE_TYPEDEF_PARSER([[[libc_blkcnt]]],	[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_BLKCNT]]])
...
DEFINE_STRING_IS_FUNCTION([[[byte]]])
DEFINE_STRING_IS_FUNCTION([[[octet]]])
...
DEFINE_STRING_IS_FUNCTION([[[libc_mode]]])
DEFINE_STRING_IS_FUNCTION([[[off]]])
DEFINE_STRING_IS_FUNCTION([[[libc_pid]]])
DEFINE_STRING_IS_FUNCTION([[[libc_uid]]])
DEFINE_STRING_IS_FUNCTION([[[libc_gid]]])
DEFINE_STRING_IS_FUNCTION([[[ptrdiff]]])
DEFINE_STRING_IS_FUNCTION([[[wchar]]])
DEFINE_STRING_IS_FUNCTION([[[wint]]])
DEFINE_STRING_IS_FUNCTION([[[libc_time]]])
DEFINE_STRING_IS_FUNCTION([[[libc_socklen]]])
DEFINE_STRING_IS_FUNCTION([[[libc_rlim]]])
DEFINE_STRING_IS_FUNCTION([[[libc_ino]]])
DEFINE_STRING_IS_FUNCTION([[[libc_dev]]])
DEFINE_STRING_IS_FUNCTION([[[libc_nlink]]])
DEFINE_STRING_IS_FUNCTION([[[libc_blkcnt]]])
