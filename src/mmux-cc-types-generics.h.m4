...
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[sin]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[cos]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[tan]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[asin]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[acos]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[atan]]])
DEFINE_GENERIC_BINARY_FUNCTION_FLONUM([[[atan2]]])

DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[sinh]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[cosh]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[tanh]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[asinh]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[acosh]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[atanh]]])

DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[exp]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[exp2]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[exp10]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[log]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[log2]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[log10]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[logb]]])

DEFINE_GENERIC_BINARY_FUNCTION_FLONUM_FLONUMC([[[pow]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[sqrt]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM_FLONUMC([[[cbrt]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[expm1]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[log1p]]])
DEFINE_GENERIC_BINARY_FUNCTION_FLONUM([[[hypot]]])

DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[erf]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[erfc]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[lgamma]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[tgamma]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[j0]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[j1]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[y0]]])
DEFINE_GENERIC_UNARY_FUNCTION_FLONUM([[[y1]]])

DEFINE_GENERIC_BINARY_FUNCTION_FLONUM_SECOND_ARG([[[jn]]])
DEFINE_GENERIC_BINARY_FUNCTION_FLONUM_SECOND_ARG([[[yn]]])
