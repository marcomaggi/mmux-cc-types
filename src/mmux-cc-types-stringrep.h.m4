...
DEFINE_STRINGREP_PROTOS([[[mode]]])
DEFINE_STRINGREP_PROTOS([[[off]]])
DEFINE_STRINGREP_PROTOS([[[pid]]])
DEFINE_STRINGREP_PROTOS([[[uid]]])
DEFINE_STRINGREP_PROTOS([[[gid]]])
DEFINE_STRINGREP_PROTOS([[[ptrdiff]]])
DEFINE_STRINGREP_PROTOS([[[wchar]]])
DEFINE_STRINGREP_PROTOS([[[wint]]])
DEFINE_STRINGREP_PROTOS([[[time]]])
DEFINE_STRINGREP_PROTOS([[[socklen]]])
DEFINE_STRINGREP_PROTOS([[[rlim]]])
DEFINE_STRINGREP_PROTOS([[[ino]]])
DEFINE_STRINGREP_PROTOS([[[dev]]])
DEFINE_STRINGREP_PROTOS([[[nlink]]])
DEFINE_STRINGREP_PROTOS([[[blkcnt]]])
