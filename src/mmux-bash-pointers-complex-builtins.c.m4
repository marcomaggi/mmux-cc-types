...
MMUX_BASH_CONDITIONAL_CODE([[[$3]]],[[[
  ...
  return mmux_bash_pointers_store_result_in_variable_$1(argv[1], Z);
error:
...
MMUX_BASH_CONDITIONAL_CODE([[[$3]]],[[[
  ...
  return mmux_bash_pointers_store_result_in_variable_$2(argv[1], part);
error:
  mmux_bash_pointers_set_ERRNO(EINVAL, MMUX_BUILTIN_NAME);
  return rv;
]]],[[[
...
MMUX_BASH_CONDITIONAL_CODE([[[$3]]],[[[
  ...
  return mmux_bash_pointers_store_result_in_variable_$1(argv[1], Zconj);
error:
  mmux_bash_pointers_set_ERRNO(EINVAL, MMUX_BUILTIN_NAME);
  return rv;
]]],[[[
...
DEFINE_CORE_COMPLEX_BUILTINS([[[complexld]]],		[[[ldouble]]],		[[[MMUX_HAVE_TYPE_COMPLEXLD]]])

DEFINE_CORE_COMPLEX_BUILTINS([[[complexf32]]],		[[[float32]]],		[[[MMUX_HAVE_TYPE_COMPLEXF32]]])
DEFINE_CORE_COMPLEX_BUILTINS([[[complexf64]]],		[[[float64]]],		[[[MMUX_HAVE_TYPE_COMPLEXF64]]])
DEFINE_CORE_COMPLEX_BUILTINS([[[complexf128]]],		[[[float128]]],		[[[MMUX_HAVE_TYPE_COMPLEXF128]]])

DEFINE_CORE_COMPLEX_BUILTINS([[[complexf32x]]],		[[[float32x]]],		[[[MMUX_HAVE_TYPE_COMPLEXF32X]]])
DEFINE_CORE_COMPLEX_BUILTINS([[[complexf64x]]],		[[[float64x]]],		[[[MMUX_HAVE_TYPE_COMPLEXF64X]]])
DEFINE_CORE_COMPLEX_BUILTINS([[[complexf128x]]],	[[[float128x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128X]]])

DEFINE_CORE_COMPLEX_BUILTINS([[[complexd32]]],		[[[decimal32]]],	[[[MMUX_HAVE_TYPE_COMPLEXD32]]])
DEFINE_CORE_COMPLEX_BUILTINS([[[complexd64]]],		[[[decimal64]]],	[[[MMUX_HAVE_TYPE_COMPLEXD64]]])
DEFINE_CORE_COMPLEX_BUILTINS([[[complexd128]]],		[[[decimal128]]],	[[[MMUX_HAVE_TYPE_COMPLEXD128]]])
