...
DEFINE_ALIASED_TYPES_SPRINTER([[[ino]]],	[[[MMUX_CC_TYPES_STEM_ALIAS_INO]]])
DEFINE_ALIASED_TYPES_SPRINTER([[[dev]]],	[[[MMUX_CC_TYPES_STEM_ALIAS_DEV]]])
DEFINE_ALIASED_TYPES_SPRINTER([[[nlink]]],	[[[MMUX_CC_TYPES_STEM_ALIAS_NLINK]]])
DEFINE_ALIASED_TYPES_SPRINTER([[[blkcnt]]],	[[[MMUX_CC_TYPES_STEM_ALIAS_BLKCNT]]])
...
DEFINE_UNSIGNED_INTEGER_SPRINTER_WITH_BASE([[[ino]]])
DEFINE_UNSIGNED_INTEGER_SPRINTER_WITH_BASE([[[dev]]])
DEFINE_UNSIGNED_INTEGER_SPRINTER_WITH_BASE([[[nlink]]])
DEFINE_UNSIGNED_INTEGER_SPRINTER_WITH_BASE([[[blkcnt]]])
...
DEFINE_STREAM_AND_CHANNEL_PRINTERS([[[ino]]])
DEFINE_STREAM_AND_CHANNEL_PRINTERS([[[dev]]])
DEFINE_STREAM_AND_CHANNEL_PRINTERS([[[nlink]]])
DEFINE_STREAM_AND_CHANNEL_PRINTERS([[[blkcnt]]])
...
DEFINE_UNSIGNED_INTEGER_DPRINTFER_WITH_BASE([[[ino]]])
DEFINE_UNSIGNED_INTEGER_DPRINTFER_WITH_BASE([[[dev]]])
DEFINE_UNSIGNED_INTEGER_DPRINTFER_WITH_BASE([[[nlink]]])
DEFINE_UNSIGNED_INTEGER_DPRINTFER_WITH_BASE([[[blkcnt]]])
