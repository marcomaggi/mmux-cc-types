...
DEFINE_ALIASED_TYPES_SPRINTER([[[libc_time]]],		[[[MMUX_CC_TYPES_STEM_ALIAS_LIBC_TIME]]])
...
DEFINE_SIGNED_INTEGER_SPRINTER_WITH_BASE([[[libc_time]]])
...
DEFINE_STREAM_AND_CHANNEL_PRINTERS([[[libc_time]]])
...
DEFINE_SIGNED_INTEGER_DPRINTFER_WITH_BASE([[[libc_time]]])
