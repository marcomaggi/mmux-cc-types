...
mmux_standard_$1_t mmux_standard_$1_constant_nan	(void) { return nan$2("nan(0)"); }
...
mmux_standard_$1_t
mmux_standard_$1_constant_positive_infinity (void)
{
  return (mmux_standard_$1_t)(+ INFINITY);
}
mmux_standard_$1_t
mmux_standard_$1_constant_negative_infinity (void)
{
  return (mmux_standard_$1_t)(- INFINITY);
}]]])]]])
m4_divert(0)m4_dnl
