...
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[mode]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[off]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[pid]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[uid]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[gid]]])
...
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[socklen]]])
DEFINE_STANDARD_EXACT_INTEGER_COMPLEX_INLINE_FUNCTIONS([[[rlim]]])
