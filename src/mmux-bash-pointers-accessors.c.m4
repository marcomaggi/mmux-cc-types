...
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[sllong]]],		[[[MMUX_HAVE_TYPE_SLLONG]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[ullong]]],		[[[MMUX_HAVE_TYPE_ULLONG]]])

MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[double]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[ldouble]]],	[[[MMUX_HAVE_TYPE_LDOUBLE]]])

MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float32]]],	[[[MMUX_HAVE_TYPE_FLOAT32]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float64]]],	[[[MMUX_HAVE_TYPE_FLOAT64]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float128]]],	[[[MMUX_HAVE_TYPE_FLOAT128]]])

MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float32x]]],	[[[MMUX_HAVE_TYPE_FLOAT32X]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float64x]]],	[[[MMUX_HAVE_TYPE_FLOAT64X]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[float128x]]],	[[[MMUX_HAVE_TYPE_FLOAT128X]]])

MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexd]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexld]]],	[[[MMUX_HAVE_TYPE_LDOUBLE]]])

MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf32]]],	[[[MMUX_HAVE_TYPE_FLOAT32]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf64]]],	[[[MMUX_HAVE_TYPE_FLOAT64]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf128]]],	[[[MMUX_HAVE_TYPE_FLOAT128]]])

MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf32x]]],	[[[MMUX_HAVE_TYPE_FLOAT32X]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf64x]]],	[[[MMUX_HAVE_TYPE_FLOAT64X]]])
MMUX_BASH_DEFINE_POINTER_ACCESSOR([[[complexf128x]]],	[[[MMUX_HAVE_TYPE_FLOAT128X]]])
