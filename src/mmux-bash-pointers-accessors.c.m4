...
MMUX_BASH_CONDITIONAL_CODE([[[$2]]],[[[
  ...
  rv = mmux_ptrdiff_parse(&offset, argv[3], MMUX_BUILTIN_NAME);
  if (MMUX_SUCCESS != rv) { mmux_bash_pointers_set_ERRNO(EINVAL, MMUX_BUILTIN_NAME); return rv; }
  ...
  return mmux_$1_bind_to_variable(argv[1], value, MMUX_BUILTIN_NAME);
]]],[[[
...
MMUX_BASH_CONDITIONAL_CODE([[[$2]]],[[[
  ...
  rv = mmux_ptrdiff_parse(&index, argv[3], MMUX_BUILTIN_NAME);
  if (MMUX_SUCCESS != rv) { mmux_bash_pointers_set_ERRNO(EINVAL, MMUX_BUILTIN_NAME); return rv; }
...
DEFINE_POINTER_ACCESSOR([[[decimal32]]],	[[[MMUX_HAVE_TYPE_DECIMAL32]]])
DEFINE_POINTER_ACCESSOR([[[decimal64]]],	[[[MMUX_HAVE_TYPE_DECIMAL64]]])
DEFINE_POINTER_ACCESSOR([[[decimal128]]],	[[[MMUX_HAVE_TYPE_DECIMAL128]]])

DEFINE_POINTER_ACCESSOR([[[complexf]]])
DEFINE_POINTER_ACCESSOR([[[complexd]]])
DEFINE_POINTER_ACCESSOR([[[complexld]]],	[[[MMUX_HAVE_TYPE_LDOUBLE]]])

DEFINE_POINTER_ACCESSOR([[[complexf32]]],	[[[MMUX_HAVE_TYPE_COMPLEXF32]]])
DEFINE_POINTER_ACCESSOR([[[complexf64]]],	[[[MMUX_HAVE_TYPE_COMPLEXF64]]])
DEFINE_POINTER_ACCESSOR([[[complexf128]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128]]])

DEFINE_POINTER_ACCESSOR([[[complexf32x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF32X]]])
DEFINE_POINTER_ACCESSOR([[[complexf64x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF64X]]])
DEFINE_POINTER_ACCESSOR([[[complexf128x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128X]]])

DEFINE_POINTER_ACCESSOR([[[complexd32]]],	[[[MMUX_HAVE_TYPE_COMPLEXD32]]])
DEFINE_POINTER_ACCESSOR([[[complexd64]]],	[[[MMUX_HAVE_TYPE_COMPLEXD64]]])
DEFINE_POINTER_ACCESSOR([[[complexd128]]],	[[[MMUX_HAVE_TYPE_COMPLEXD128]]])
