...
DEFINE_TYPE_STRING_REP_PREDICATE([[[decimal32]]],	[[[MMUX_HAVE_TYPE_DECIMAL32]]])
DEFINE_TYPE_STRING_REP_PREDICATE([[[decimal64]]],	[[[MMUX_HAVE_TYPE_DECIMAL64]]])
DEFINE_TYPE_STRING_REP_PREDICATE([[[decimal128]]],	[[[MMUX_HAVE_TYPE_DECIMAL128]]])
...
DEFINE_TYPE_STRING_REP_PREDICATE([[[complexf128]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128]]])

DEFINE_TYPE_STRING_REP_PREDICATE([[[complexf32x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF32X]]])
DEFINE_TYPE_STRING_REP_PREDICATE([[[complexf64x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF64X]]])
DEFINE_TYPE_STRING_REP_PREDICATE([[[complexf128x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128X]]])

DEFINE_TYPE_STRING_REP_PREDICATE([[[complexd32]]],	[[[MMUX_HAVE_TYPE_COMPLEXD32]]])
DEFINE_TYPE_STRING_REP_PREDICATE([[[complexd64]]],	[[[MMUX_HAVE_TYPE_COMPLEXD64]]])
DEFINE_TYPE_STRING_REP_PREDICATE([[[complexd128]]],	[[[MMUX_HAVE_TYPE_COMPLEXD128]]])
...
DEFINE_ALL_ARITHMETIC_PREDICATES([[[decimal32]]],	[[[MMUX_HAVE_TYPE_DECIMAL32]]])
DEFINE_ALL_ARITHMETIC_PREDICATES([[[decimal64]]],	[[[MMUX_HAVE_TYPE_DECIMAL64]]])
DEFINE_ALL_ARITHMETIC_PREDICATES([[[decimal128]]],	[[[MMUX_HAVE_TYPE_DECIMAL128]]])
...
DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexf128]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128]]])

DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexf32x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF32X]]])
DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexf64x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF64X]]])
DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexf128x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128X]]])

DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexd32]]],	[[[MMUX_HAVE_TYPE_COMPLEXD32]]])
DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexd64]]],	[[[MMUX_HAVE_TYPE_COMPLEXD64]]])
DEFINE_ALL_ARITHMETIC_PREDICATES_FOR_NONSIGNED([[[complexd128]]],	[[[MMUX_HAVE_TYPE_COMPLEXD128]]])
