...
MMUX_BASH_CONDITIONAL_CODE([[[$5]]],[[[
  ...
  rop = mmux_$1_$2(op);
  return mmux_$1_bind_to_variable(argv[1], rop, MMUX_BUILTIN_NAME_STR);
...
DEFINE_BUILTINS([[[decimal32]]],
		  [[[MMUX_BASH_PARSE_BUILTIN_ARG_DECIMAL32]]],	[[[MMUX_HAVE_CC_TYPE_DECIMAL32_UNIMPLEMENTED]]],
...
DEFINE_BUILTINS([[[decimal64]]],
		  [[[MMUX_BASH_PARSE_BUILTIN_ARG_DECIMAL64]]],	[[[MMUX_HAVE_CC_TYPE_DECIMAL64_UNIMPLEMENTED]]],
...
DEFINE_BUILTINS([[[decimal128]]],
		  [[[MMUX_BASH_PARSE_BUILTIN_ARG_DECIMAL128]]],	[[[MMUX_HAVE_CC_TYPE_DECIMAL128_UNIMPLEMENTED]]],
