...
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[sllong]]],		[[[MMUX_HAVE_TYPE_SLLONG]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[ullong]]],		[[[MMUX_HAVE_TYPE_ULLONG]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[double]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[ldouble]]],		[[[MMUX_HAVE_TYPE_LDOUBLE]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float32]]],		[[[MMUX_HAVE_TYPE_FLOAT32]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float64]]],		[[[MMUX_HAVE_TYPE_FLOAT64]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float128]]],	[[[MMUX_HAVE_TYPE_FLOAT128]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float32x]]],	[[[MMUX_HAVE_TYPE_FLOAT32X]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float64x]]],	[[[MMUX_HAVE_TYPE_FLOAT64X]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[float128x]]],	[[[MMUX_HAVE_TYPE_FLOAT128X]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[decimal32]]],	[[[MMUX_HAVE_TYPE_DECIMAL32]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[decimal64]]],	[[[MMUX_HAVE_TYPE_DECIMAL64]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[decimal128]]],	[[[MMUX_HAVE_TYPE_DECIMAL128]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexd]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexld]]],	[[[MMUX_HAVE_TYPE_LDOUBLE]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf32]]],	[[[MMUX_HAVE_TYPE_COMPLEXF32]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf64]]],	[[[MMUX_HAVE_TYPE_COMPLEXF64]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf128]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf32x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF32X]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf64x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF64X]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexf128x]]],	[[[MMUX_HAVE_TYPE_COMPLEXF128X]]])

MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexd32]]],	[[[MMUX_HAVE_TYPE_COMPLEXD32]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexd64]]],	[[[MMUX_HAVE_TYPE_COMPLEXD64]]])
MMUX_BASH_DEFINE_POINTER_MUTATOR([[[complexd128]]],	[[[MMUX_HAVE_TYPE_COMPLEXD128]]])
