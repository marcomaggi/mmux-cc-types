...
static int
mmux_$1_pointer_set_main (int argc MMUX_BASH_POINTERS_UNUSED, char const * const argv[])
...
static int
mmux_$1_array_set_main (int argc MMUX_BASH_POINTERS_UNUSED, char const * const argv[])
#undef  MMUX_BUILTIN_NAME
