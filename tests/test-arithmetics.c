...
#define DOIT_FOR_FLONUM(STEM)				    \
  ...
  DOIT_FOR_UNSIGNED_EXACT_INTEGER(mode);
  DOIT_FOR_SIGNED_EXACT_INTEGER(off);
  DOIT_FOR_SIGNED_EXACT_INTEGER(pid);
  DOIT_FOR_UNSIGNED_EXACT_INTEGER(uid);
  DOIT_FOR_UNSIGNED_EXACT_INTEGER(gid);
  ...
  DOIT_FOR_UNSIGNED_EXACT_INTEGER(socklen);
  DOIT_FOR_UNSIGNED_EXACT_INTEGER(rlim);
