...
test_sign_predicate_is_non_negative (void)
{
  ...
  { mmux_float_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}

  { mmux_double_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_double_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_double_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}

#ifdef MMUX_CC_TYPES_HAS_LDOUBLE
  { mmux_ldouble_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_ldouble_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_ldouble_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_FLOAT32
  { mmux_float32_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_float32_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float32_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_FLOAT64
  { mmux_float64_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_float64_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float64_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_FLOAT128
  { mmux_float128_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_float128_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float128_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_FLOAT32X
  { mmux_float32x_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_float32x_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float32x_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_FLOAT64X
  { mmux_float64x_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_float64x_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float64x_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_FLOAT128X
  { mmux_float128x_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_float128x_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_float128x_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_DECIMAL32
  { mmux_decimal32_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_decimal32_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_decimal32_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_DECIMAL64
  { mmux_decimal64_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_decimal64_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_decimal64_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif

#ifdef MMUX_CC_TYPES_HAS_DECIMAL128
  { mmux_decimal128_t	value = -0.0;	assert(true  == mmux_ctype_is_non_negative(value));	}
  { mmux_decimal128_t	value = +0.0;	assert(false == mmux_ctype_is_non_negative(value));	}
  { mmux_decimal128_t	value = 1;	assert(false == mmux_ctype_is_non_negative(value));	}
#endif
