...
#define DOIT_FOR_FLONUMC(STEM)						\
  ...
  DOIT_FOR_EXACT_INTEGER(libc_mode);
  DOIT_FOR_EXACT_INTEGER(off);
  DOIT_FOR_EXACT_INTEGER(libc_pid);
  DOIT_FOR_EXACT_INTEGER(libc_uid);
  DOIT_FOR_EXACT_INTEGER(libc_gid);
  ...
  DOIT_FOR_EXACT_INTEGER(libc_dev);
  DOIT_FOR_EXACT_INTEGER(libc_nlink);
  DOIT_FOR_EXACT_INTEGER(libc_blkcnt);
...
/* ------------------------------------------------------------------ */
  ...
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_mode);
  DOIT_FOR_EXACT_SIGNED_INTEGER(off);
  DOIT_FOR_EXACT_SIGNED_INTEGER(libc_pid);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_uid);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_gid);
  DOIT_FOR_EXACT_SIGNED_INTEGER(ptrdiff);
  DOIT_FOR_EXACT_SIGNED_INTEGER(wchar);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(wint);
  DOIT_FOR_EXACT_SIGNED_INTEGER(libc_time);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_socklen);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_rlim);

  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_ino);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_dev);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_nlink);
  DOIT_FOR_EXACT_UNSIGNED_INTEGER(libc_blkcnt);
